...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch fennee_config gazebo.launch 
...
Spawning a robot:
    ...
    roslaunch fennee_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
